...
-- More convenient terminal exit with jk (similar to jj for insert mode)
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('CursorHold', {
        callback = function()
          -- Use a timer to delay the execution of the diagnostics popup
          vim.defer_fn(function()
            show_diagnostics()
          end, 1000) -- Delay in milliseconds (1 second)
        end,
      })
